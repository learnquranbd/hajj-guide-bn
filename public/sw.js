...
const CACHE = 'hajj-guide-v15';   /* bump-version.sh এটি হালনাগাদ করে */
...
const CORE = [
  ...
  '/tips', '/checklist', '/qiran', '/ifrad', '/sources',
  OFFLINE, OFFLINE_ALT,
  '/css/style.css?v=15',
  '/js/shell.js?v=15', '/js/store.js?v=15', '/js/analytics.js?v=15', '/js/firebase-config.js?v=15',
  '/js/data-steps.js?v=15', '/js/data-dua.js?v=15', '/js/data-salat.js?v=15',
  '/js/data-checklist.js?v=15', '/js/data-umrah.js?v=15', '/js/data-faq.js?v=15',
  '/js/data-terms.js?v=15', '/js/data-ziyarat.js?v=15', '/js/data-hajj-types.js?v=15',
  '/js/data-timeline.js?v=15', '/js/data-quran-hadith.js?v=15',
